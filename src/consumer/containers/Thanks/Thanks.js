    ...
    return (
      <>
        ...
        >
          ...
          <p style={{ color: "gray" }}>
            <span style={{ fontSize: "1.5rem" }}>🍜</span> Please check your
            email for points earned.{" "}
          </p>
          <p style={{ color: "gray" }}>
            <span style={{ fontSize: "1.5rem" }}>🍜</span> Earn points to
            recieve free food.{" "}
          </p>
          <p style={{ color: "gray" }}>
            <span style={{ fontSize: "1.5rem" }}>🍜</span> Share Parakeet with
            friends.{" "}
          </p>
        </div>
